		...
		try (PrintWriter pw = response.getWriter()) {
			...
			if (user == null)
			  ...
			  //not null => successful login : send validate user details to clnt
				...
				//In case of successful login , navigate the client to TopicsServlet in the same request 
				...
				//2. Forward the client to the next page in the same request 
				//Method of RD: public void forward (ServletRequest rq, ServetResponse rs)
